...
export const product_apis = {
    ...
    list: (page:string|number,offset:string|number,searchQuery?:string|null)=>get(`/products/${page}/${offset}${searchQuery??''}`),
...
export const client_apis = {
    ...
    list: (page:string|number,offset:string|number,searchQuery?:string|null)=>get(`/clients/${page}/${offset}${searchQuery??''}`),
...
export const vehicle_apis = {
    ...
    list: (page:string|number,offset:string|number,searchQuery?:string|null)=>get(`/vehicles/${page}/${offset}${searchQuery??''}`),
...
export const user_apis = {
    ...
    list:(page:string|number,offset:string|number,searchQuery?:string|null)=>get(`/users/${page}/${offset}${searchQuery??''}`),
    select:(data:FormData,id:string|number)=>post(`/user-details/${id}`,data),
